...
const showAllTextButton = document.querySelector(
  ".button-yellow_place_about-production"
);
const textColumns = document.querySelector(".about-production__textcolumns");

const input = document.getElementById("phone-input");
const oneMoreInput = document.getElementById("phone-input-one-more");
const maskOptions = {
...
const handleShowAllText = () => {
  ...
  showAllTextButton.classList.add(
    "button-yellow_place_about-production_hidden"
  );
};
